...
class  _Conversation extends State<Conversation> {
  ...
  Future saveChatImg()async{
    ...
    print(imagename);
    print(base64);
    var url = 'https://'+IP4+'/testlocalhost/PHP/save_ChatIMG.php';
                 ...
                 :BorderRadius.only(
                  ...
                  Container(
                    ...
                    child:ClipRRect(
                      ...
                      child: Image.network('https://' + IP4 + '/testlocalhost/PHP/chat/' + massege,width:180,height:130,fit: BoxFit.cover,),),);
