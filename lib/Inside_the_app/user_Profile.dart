...
class _USER_PROFILE extends State<USER_PROFILE> {
  ...
  Future getdata()async{
    var url='https://'+IP4+'/testlocalhost/PHP/all_worker.php';
    ...
    return Column(
        children:<Widget>[
          ...
          Container(
            ...
            child:Center(
              child:CircleAvatar(backgroundImage: NetworkImage('https://'+IP4+'/testlocalhost/PHP/upload/'+widget.image,),radius: 35.0,),),
          ),
          Container(
            margin: EdgeInsets.only(top:10),
            child:Center(
                        ...
                        Padding(
                          ...
                          child: RaisedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => MyApp1(work: 'نجار',name_Me: widget.name_Me,location: widget.country,),),
                              );
                            },
                            shape: new RoundedRectangleBorder(
...
class DataSearch extends SearchDelegate<String>{
  ...
  Future getSearch()async{
    var url='https://'+IP4+'/testlocalhost/PHP/groupsearch.php';
    var ressponse=await http.post(url,body: {
      "Work":query,
    });
    // ignore: deprecated_member_use
