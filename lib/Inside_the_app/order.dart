...
class _order extends State<order> {
  ...
  Future getList() async {
    var url = 'https://' + IP4 + '/testlocalhost/PHP/getList.php';
    ...
    return Directionality(textDirection: ui.TextDirection.rtl,
      child: Scaffold(
        ...
        body: Column(
          children: [
            Container(
               child:user_order(phone: widget.phone,ListB:ListBlock,),
              ),
          ],
...
class user_order extends StatefulWidget {
  ...
  final Dateformate;
  List<dynamic>ListB;
  user_order({this.phone,this.Dateformate,this.ListB});
  @override
...
class _user_order extends State<user_order> {
  ...
  void _onDaySelected(DateTime day, List events,List r) {
    ...
    Navigator.push(context,MaterialPageRoute(builder: (context) => order(phone:widget.phone,),));
    setState(() {
