...
class  _PROFILE extends State< PROFILE> {
  ...
  Future getdata1()async{
    var url='https://'+IP4+'/testlocalhost/PHP/count.php';
  ...
  Future getdata2()async{
    var url='https://'+IP4+'/testlocalhost/PHP/count2.php';
    var ressponse=await http.post(url,body: {
      "phone": phone,
    });
    var responsepody= json.decode(ressponse.body);
  ...
  Future getWorker()async{
    var url='https://'+IP4+'/testlocalhost/PHP/getworker.php';
    var ressponse=await http.post(url,body: {
      "name": widget.name,
    });
...
class _Profile_woeker extends State<Profile_worker> {
  ...
  Future getpost()async{
    var url='https://'+IP4+'/testlocalhost/PHP/getpost.php';
    var ressponse=await http.post(url,body: {
      "phone": widget.phone,
    });
    // ignore: deprecated_member_use
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      if(image==true){
                                        ...
                                        if(snapshot.data.length==1){
                                          return myAlbum1('https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index]['images']);
                                        }
                                        if(snapshot.data.length==2){
                                          return myAlbum2('https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index]['images'],'https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index+1]['images']);
                                        }
                                        if(snapshot.data.length==3){
                                          return myAlbum3('https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index]['images'],'https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index+1]['images'],'https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index+2]['images']);
                                        }
                                        return myAlbum('https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index]['images'],'https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index+1]['images'],'https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index+2]['images'],'https://'+IP4+'/testlocalhost/PHP/upload/'+snapshot.data[index+3]['images'],num.toString()+"+");
                                      }
                                      return Container();
                                    }
                                );
  ...
  Future uploadFile() async {
    ...
    print("hiiii");
    print(imagename);
    var url = 'https://' + IP4 + '/testlocalhost/PHP/EXP_Image.php';
      ...
      child: Column(
        children: [
          ...
          image!="null"?Container(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(10.0),
              child: Image.network('https://'+IP4+'/testlocalhost/PHP/upload/'+ image, height: 200, width: 300, fit: BoxFit.cover,),
            ),):Container(),
        ],
      ),
    );
...
class _MyDialogState extends State<MyDialog> {
  ...
  Future senddata()async{
    if(image==null){
      print("image null");
      var url = 'https://'+IP4+'/testlocalhost/PHP/add_post.php';
      var ressponse = await http.post(url, body: {
        "text": text_post.text,
        "phone": widget.phone,
        "imagename": 'null',
