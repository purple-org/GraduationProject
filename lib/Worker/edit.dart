...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future editpersonalinfo ()async{
    ...
    var url = 'https://'+IP4+'/testlocalhost/PHP/edit.php';
    if(image_file==null){
      print("image null");
  ...
  Widget image_profile(){
    return Center(
      child:Stack (children: <Widget>[
        CircleAvatar(
          backgroundImage: image_file==null? NetworkImage('https://'+IP4+'/testlocalhost/PHP/upload/'+widget.image):FileImage(File(image_file.path)),
          radius: 60.0,
        ),
        Positioned(
          bottom:10.0,
